...
export default function NewsSection() {
  return (
    <div className="w-full flex flex-col items-center justify-center pt-24 pb-32 space-y-14 bg-gray-200">
      ...
      <div className="flex max-w-screen-lg space-x-16">
        ...
        <div className="w-1/2 flex flex-col space-y-6">
          <div className="flex items-center justify-center space-x-4">
            ...
            <div className="flex flex-col flex-1">
              <div className="text-black hover:text-red-500 cursor-pointer text-lg font-bold">
                Cruz talks 'ominous development' in Clinton
              </div>
